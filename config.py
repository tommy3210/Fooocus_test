...
@@ -98,52 +79,23 @@ def replace_config(old_key, new_key):
...
@@ -152,70 +104,36 @@ def get_dir_or_set_default(key, default_value, as_array=False, make_directory=Fa
...
@@ -233,145 +151,66 @@ def get_config_item_or_set_default(key, default_value, validator, disable_empty_
        return default_value
...
default_styles = get_config_item_or_set_default(
    key='default_styles',
@@ -380,379 +219,126 @@ def init_temp_path(path: str | None, default_path: str) -> str:
        "Fooocus Enhance",
        "Fooocus Sharp"
    ],
...
@@ -861,28 +436,10 @@ def downloading_inpaint_models(v):
...
@@ -949,49 +506,5 @@ def downloading_upscale_model():
    )
